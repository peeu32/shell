...
cp data/raw/rawdata/*server*log*.log data/processed/server_logs

# 6. Repeat the above step for user logs and event logs
cp data/raw/rawdata/*user*log*.log data/processed/user_logs && cp data/raw/rawdata/*event*log*.log data/processed/event_logs
